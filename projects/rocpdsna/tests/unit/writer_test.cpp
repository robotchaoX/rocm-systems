...
rocpdsna::writer_types::node_info_t
create_test_node_info(size_t node_id = 1)
{
    ...
    return rocpdsna::writer_types::node_info_t{ .node_id       = node_id,
...
rocpdsna::writer_types::process_info_t
create_test_process_info(size_t node_id = 1, size_t pid = 1000)
{
    return rocpdsna::writer_types::process_info_t{ .ppid        = 1,
                                                   .pid         = pid,
                                                   .init        = 1000000,
                                                   .fini        = 2000000,
                                                   .start       = 1000000,
...
rocpdsna::writer_types::thread_info_t
create_test_thread_info(size_t node_id    = 1,
                        size_t process_id = 1000,
                        size_t thread_id  = 100)
{
    return rocpdsna::writer_types::thread_info_t{ .parent_process_id = process_id,
                                                  .thread_id         = thread_id,
                                                  .name              = "test-thread",
                                                  .start             = 1000000,
                                                  .end               = 2000000,
...
rocpdsna::writer_types::agent_info_t
create_test_agent_info(size_t      node_id    = 1,
                       size_t      process_id = 1000,
                       const char* agent_type = "GPU",
                       size_t      type_index = 0)
{
    return rocpdsna::writer_types::agent_info_t{
...
rocpdsna::writer_types::stream_info_t
create_test_stream_info(size_t node_id    = 1,
                        size_t process_id = 1000,
                        size_t stream_id  = 1)
{
    return rocpdsna::writer_types::stream_info_t{ .stream_id  = stream_id,
                                                  .name       = "test-stream",
                                                  .extdata    = "{}",
                                                  .node_id    = node_id,
                                                  .process_id = process_id };
...
rocpdsna::writer_types::queue_info_t
create_test_queue_info(size_t node_id = 1, size_t process_id = 1000, size_t queue_id = 1)
{
    return rocpdsna::writer_types::queue_info_t{ .queue_id   = queue_id,
                                                 .name       = "test-queue",
                                                 .extdata    = "{}",
                                                 .node_id    = node_id,
                                                 .process_id = process_id };
...
rocpdsna::writer_types::pmc_info_t
create_test_pmc_info(
    size_t                                                   node_id    = 1,
    size_t                                                   process_id = 1000,
    const char*                                              name       = "test_counter",
    std::optional<rocpdsna::writer_types::agent_unique_id_t> agent_id   = std::nullopt)
{
    return rocpdsna::writer_types::pmc_info_t{ .unique_id   = { .name     = name,
                                                                .agent_id = agent_id },
                                               .target_arch = "GPU",
                                               .event_code  = 100,
                                               .instance_id = 0,
...
rocpdsna::writer_types::code_object_info_t
create_test_code_object_info(size_t                                    code_object_id = 1,
                             size_t                                    node_id        = 1,
                             size_t                                    process_id = 1000,
                             rocpdsna::writer_types::agent_unique_id_t agent_id = { "GPU",
                                                                                    0 })
{
    return rocpdsna::writer_types::code_object_info_t{ .id  = code_object_id,
...
rocpdsna::writer_types::kernel_symbol_info_t
create_test_kernel_symbol_info(size_t kernel_symbol_id = 1,
                               size_t node_id          = 1,
                               size_t process_id       = 1000,
                               size_t code_object_id   = 1)
{
    return rocpdsna::writer_types::kernel_symbol_info_t{ .id           = kernel_symbol_id,
                                                         .name         = "test_kernel",
...
create_test_track_info(
    ...
    std::optional<rocpdsna::writer_types::track_name_t> name       = "test-track")
{
    return rocpdsna::writer_types::track_info_t{ .name       = name,
                                                 .extdata    = "{}",
                                                 .node_id    = node_id,
                                                 .process_id = process_id,
                                                 .thread_id  = thread_id };
...
create_test_trace_environment(size_t node_id    = 1,
                              ...
                              size_t thread_id  = 100)
{
    return rocpdsna::writer_types::trace_environment_t{ .node_id    = node_id,
                                                        .process_id = process_id,
                                                        .thread_id  = thread_id,
...
rocpdsna::writer_types::pmc_event_data_t
create_test_pmc_event_data(double value = 42.5)
{
    return rocpdsna::writer_types::pmc_event_data_t{
        .event   = std::nullopt,
        .value   = value,
        .extdata = "{}",
...
rocpdsna::writer_types::kernel_dispatch_data_t
create_test_kernel_dispatch_data(size_t kernel_symbol_id = 1, size_t code_object_id = 1)
{
    return rocpdsna::writer_types::kernel_dispatch_data_t{ .event       = std::nullopt,
                                                           .dispatch_id = 1,
...
rocpdsna::writer_types::memory_copy_data_t
create_test_memory_copy_data()
{
    return rocpdsna::writer_types::memory_copy_data_t{ .event           = std::nullopt,
                                                       .start_timestamp = 1000000,
                                                       .end_timestamp   = 2000000,
...
void
register_base_dependencies(rocpdsna::writer_t& writer,
                           size_t              node_id    = 1,
                           size_t              process_id = 1000,
                           size_t              thread_id  = 100)
{
...
protected:
    ...
    std::shared_ptr<rocpdsna::writer_t>  m_writer;
};
...
TEST_F(writer_test, insert_pmc_event_data_without_pmc_throws)
{
    ...
    auto pmc_unique_id = rocpdsna::writer_types::pmc_info_unique_id_t{
...
TEST_F(writer_test, insert_memory_copy_with_all_dependencies)
{
    ...
    memory_copy.src_agent_id = rocpdsna::writer_types::agent_unique_id_t{ "CPU", 0 };
    memory_copy.dst_agent_id = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 0 };
...
TEST_F(writer_test, insert_memory_copy_without_node_throws)
{
    auto memory_copy = create_test_memory_copy_data();
    auto environment =
        rocpdsna::writer_types::trace_environment_t{ .node_id    = 999,
                                                     .process_id = 1000,
                                                     .thread_id  = std::nullopt,
                                                     .agent_id   = std::nullopt,
                                                     .stream_id  = std::nullopt,
...
TEST_F(writer_test, insert_memory_copy_with_unregistered_src_agent_throws)
{
    ...
    auto memory_copy         = create_test_memory_copy_data();
    memory_copy.src_agent_id = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 999 };
...
TEST_F(writer_test, insert_memory_alloc_with_unregistered_agent_throws)
{
    ...
    auto environment  = rocpdsna::writer_types::trace_environment_t{
         ...
         .process_id = 1000,
         .thread_id  = std::nullopt,
         .agent_id   = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 999 },
         .stream_id  = std::nullopt,
         .queue_id   = std::nullopt,
         .track_name = std::nullopt
    };
...
TEST_F(writer_test, insert_memory_copy_with_unregistered_dst_agent_throws)
{
    ...
    auto memory_copy         = create_test_memory_copy_data();
    memory_copy.dst_agent_id = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 999 };
...
TEST_F(writer_test, insert_pmc_event_data_with_event)
{
    ...
    pmc_event.event = rocpdsna::writer_types::event_data_t{ .stack_id        = 10,
                                                            .parent_stack_id = 0,
                                                            .correlation_id  = 456,
                                                            .call_stack      = {},
                                                            .line_info_list  = {},
...
{
    auto node = rocpdsna::writer_types::node_info_t{ .node_id       = 1,
                                                     .hash          = 987654321,
    ...
    auto process =
        rocpdsna::writer_types::process_info_t{ .ppid  = 1,
                                                .pid   = 12345,
                                                .init  = 1000000000,
                                                .fini  = 9000000000,
                                                .start = 1000000000,
    ...
    auto thread = rocpdsna::writer_types::thread_info_t{ .parent_process_id = 12345,
                                                         .thread_id         = 100,
                                                         .name       = "main-thread",
                                                         .start      = 1000000000,
                                                         .end        = 9000000000,
    ...
    auto gpu_agent = rocpdsna::writer_types::agent_info_t{
    ...
    auto cpu_agent =
        rocpdsna::writer_types::agent_info_t{ .unique_id      = { .agent_type = "CPU",
                                                                  .type_index = 0 },
                                              .absolute_index = 0,
                                              .logical_index  = 0,
                                              .uuid           = 0,
    ...
    auto queue = rocpdsna::writer_types::queue_info_t{ .queue_id   = 1,
    ...
    auto stream = rocpdsna::writer_types::stream_info_t{ .stream_id  = 1,
                                                         .name       = "hip-stream-0",
                                                         .extdata    = "{}",
                                                         .node_id    = 1,
                                                         .process_id = 12345 };
    ...
    rocpdsna::writer_types::agent_unique_id_t pmc_agent_id{ "GPU", 0 };
    auto                                      pmc = rocpdsna::writer_types::pmc_info_t{
    ...
    auto code_object = rocpdsna::writer_types::code_object_info_t{
        .id           = 1,
    ...
    auto kernel_symbol =
        rocpdsna::writer_types::kernel_symbol_info_t{ .id = 1,
                                                      .name =
    ...
    auto track = rocpdsna::writer_types::track_info_t{ .name       = "HIP_API",
                                                       .extdata    = "{}",
                                                       .node_id    = 1,
                                                       .process_id = 12345,
                                                       .thread_id  = 100 };
    ...
    auto region = rocpdsna::writer_types::region_data_t{
    ...
    auto pmc_event = rocpdsna::writer_types::pmc_event_data_t{
        .event   = std::nullopt,
        .value   = 1024.0,
        .extdata = "{}",
    ...
    auto pmc_unique_id =
        rocpdsna::writer_types::pmc_info_unique_id_t{ .name     = "SQ_WAVES",
                                                      .agent_id = pmc_agent_id };
    m_writer->insert_pmc_event_data(pmc_event, pmc_unique_id);

    auto kernel_dispatch =
        rocpdsna::writer_types::kernel_dispatch_data_t{ .event            = std::nullopt,
                                                        .dispatch_id      = 1,
                                                        ...
                                                        .extdata = "{}" };
    auto kernel_env = rocpdsna::writer_types::trace_environment_t{
        .node_id    = 1,
        .process_id = 12345,
        .thread_id  = 100,
        .agent_id   = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 0 },
    ...
    auto memory_copy = rocpdsna::writer_types::memory_copy_data_t{
        .event           = std::nullopt,
    ...
    auto memory_alloc =
        rocpdsna::writer_types::memory_alloc_data_t{ .event           = std::nullopt,
                                                     .type            = "ALLOC",
                                                     .level           = "REAL",
                                                     .start_timestamp = 2000000000,
                                                     ...
                                                     .size            = 1048576,
                                                     .extdata         = "{}" };
    auto alloc_env = rocpdsna::writer_types::trace_environment_t{
        .node_id    = 1,
        .process_id = 12345,
        .thread_id  = 100,
        .agent_id   = rocpdsna::writer_types::agent_unique_id_t{ "GPU", 0 },
...
TEST_F(writer_test, insert_region_data_with_track_creates_sample)
{
    ...
    auto track = rocpdsna::writer_types::track_info_t{ .name       = "API_TRACK",
                                                       .extdata    = "{}",
                                                       .node_id    = 1,
                                                       .process_id = 1000,
                                                       .thread_id  = 100 };
...
TEST_F(writer_test, insert_multiple_regions_same_track_creates_multiple_samples)
{
    ...
    auto track = rocpdsna::writer_types::track_info_t{ .name       = "MULTI_SAMPLE_TRACK",
                                                       .extdata    = "{}",
                                                       .node_id    = 1,
                                                       .process_id = 1000,
                                                       .thread_id  = 100 };
...
TEST_F(writer_test, sample_references_correct_track_id)
{
    ...
    auto track = rocpdsna::writer_types::track_info_t{ .name       = "REFERENCED_TRACK",
                                                       .extdata    = "{}",
                                                       .node_id    = 1,
                                                       .process_id = 1000,
                                                       .thread_id  = 100 };
...
TEST_F(writer_test, sample_timestamp_matches_region_start)
{
    ...
    auto track = rocpdsna::writer_types::track_info_t{ .name       = "TIMESTAMP_TRACK",
                                                       .extdata    = "{}",
                                                       .node_id    = 1,
                                                       .process_id = 1000,
                                                       .thread_id  = 100 };
...
TEST_F(writer_test, multiple_tracks_with_different_regions)
{
    ...
    auto track1 = rocpdsna::writer_types::track_info_t{ .name       = "TRACK_A",
                                                        .extdata    = "{}",
                                                        .node_id    = 1,
                                                        .process_id = 1000,
                                                        .thread_id  = 100 };
    auto track2 = rocpdsna::writer_types::track_info_t{ .name       = "TRACK_B",
                                                        .extdata    = "{}",
                                                        .node_id    = 1,
                                                        .process_id = 1000,
                                                        .thread_id  = 100 };
    ...
    auto env_a = rocpdsna::writer_types::trace_environment_t{ .node_id    = 1,
                                                              .process_id = 1000,
                                                              .thread_id  = 100,
                                                              .agent_id   = std::nullopt,
                                                              .stream_id  = std::nullopt,
    ...
    auto env_b = rocpdsna::writer_types::trace_environment_t{ .node_id    = 1,
                                                              .process_id = 1000,
                                                              .thread_id  = 100,
                                                              .agent_id   = std::nullopt,
                                                              .stream_id  = std::nullopt,
