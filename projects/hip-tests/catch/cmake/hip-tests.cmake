...
if (HIP_PLATFORM MATCHES "nvidia")
  set_source_files_properties(${SRC_NAME} PROPERTIES LANGUAGE CUDA)
...
if (HIP_PLATFORM MATCHES "nvidia")
  set_target_properties(${_EXE_NAME} PROPERTIES LINKER_LANGUAGE CUDA)
elseif( HIP_PLATFORM MATCHES "amd")
    ...
    if (NOT HIP_PLATFORM MATCHES "nvidia")
